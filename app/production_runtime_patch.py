...
def _components() -> dict:
    return {
        ...
        "TurnContractWithPromptPreview": _object_schema({"session_id": {"type": "string"}, "mode": {"type": "string"}, "active_character_ids": _array_string(), "nearby_character_ids": _array_string(), "required_files": _array_string(), "output_format_contract": _object_schema(), "required_checks_before_answer": _array_string(), "knowledge_table": _object_schema(), "inventory_contract": _object_schema(), "relationship_context": _object_schema(), "story_context": _object_schema(), "prompt_preview": {"type": "string"}, "fast_context_available": {"type": "boolean"}, "preferred_next_action": {"type": "string"}, "usage_note": {"type": "string"}}, required=["session_id", "required_files", "prompt_preview"]),
        "RequiredFilesManifestResponse": _object_schema({"session_id": {"type": "string"}, "mode": {"type": "string"}, "cache_enabled": {"type": "boolean"}, "required_files": _array_string(), "files": {"type": "array", "items": _object_schema()}, "missing_files": _array_string(), "chunks_total": {"type": "integer"}, "loaded_count": {"type": "integer"}, "missing_count": {"type": "integer"}}),
        "RequiredFilesChunkResponse": _object_schema({"session_id": {"type": "string"}, "mode": {"type": "string"}, "cache_enabled": {"type": "boolean"}, "cache_hit": {"type": "boolean"}, "required_files": _array_string(), "chunk_index": {"type": "integer"}, "chunks_total": {"type": "integer"}, "has_more": {"type": "boolean"}, "next_chunk_index": {"type": "integer"}, "loaded_files": {"type": "array", "items": _object_schema()}, "missing_files": _array_string(), "loaded_count": {"type": "integer"}, "missing_count": {"type": "integer"}, "total_loaded_parts": {"type": "integer"}}),
        "FastRenderContextResponse": _object_schema({"success": {"type": "boolean"}, "session_id": {"type": "string"}, "mode": {"type": "string"}, "quality_mode": {"type": "string"}, "required_files_total": {"type": "integer"}, "loaded_files": {"type": "array", "items": _object_schema()}, "loaded_count": {"type": "integer"}, "skipped_files": _array_string(), "skipped_count": {"type": "integer"}, "truncated": {"type": "boolean"}, "needs_full_context": {"type": "boolean"}, "past_context_loaded": {"type": "boolean"}, "render_rules": _array_string()}),
...
def _fast_context_params() -> list[dict]:
    return [
        {"name": "max_total_chars", "in": "query", "required": False, "schema": {"type": "integer", "default": 45000, "minimum": 24000, "maximum": 70000}},
        {"name": "per_file_chars", "in": "query", "required": False, "schema": {"type": "integer", "default": 8000, "minimum": 2500, "maximum": 14000}},
