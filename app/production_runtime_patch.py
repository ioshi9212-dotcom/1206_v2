...
def _components() -> dict:
    return {
        ...
        "FastRenderContextResponse": _object_schema({"success": {"type": "boolean"}, "session_id": {"type": "string"}, "mode": {"type": "string"}, "quality_mode": {"type": "string"}, "context_files_total": {"type": "integer"}, "loaded_files": {"type": "array", "items": _object_schema()}, "loaded_count": {"type": "integer"}, "skipped_files": _array_string(), "skipped_count": {"type": "integer"}, "truncated": {"type": "boolean"}, "needs_full_context": {"type": "boolean"}, "past_context_loaded": {"type": "boolean"}, "render_rules": _array_string()}),
...
def _fast_context_params() -> list[dict]:
    return [
        {"name": "max_total_chars", "in": "query", "required": False, "schema": {"type": "integer", "default": 24000, "minimum": 12000, "maximum": 36000}},
        {"name": "per_file_chars", "in": "query", "required": False, "schema": {"type": "integer", "default": 4000, "minimum": 1800, "maximum": 7000}},
...
def _openapi() -> dict[str, Any]:
    return {
        ...
        "paths": {
            ...
            "/api/v1/sessions/{session_id}/fast-render-context": {"get": {"operationId": "getFastRenderContext", "summary": "Get fast render context for normal gameplay: runtime digest, active character files, and selected state slices", "parameters": [_session_path_param()] + _fast_context_params(), "responses": {"200": _response("Fast render context", "FastRenderContextResponse")}}},
