...
## Medium scene style digest — strict 1206 scene format
Use the selected 1206 visual-novel header/footer. Energy should be visually/physically felt when relevant: cold, heat, sound, vibration, pressure, metal tremor, trajectory shift. Personal energy is in character cards, not in separate per-type files.
"""
