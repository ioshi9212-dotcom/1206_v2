...
LORE_ALWAYS_FILES=["canon_lore/core/world_background.yaml","canon_lore/core/story_background.yaml","canon_lore/hidden/hidden_lore_policy.yaml"]
...
def lore_files_for_context(current:dict[str,Any], scene_character_ids:list[str], story_lines:Any=None)->list[str]:
    ...
    if any(k in text for k in ["нпс","слух","провокац","флирт","ревност","мини-ар","статус","фоновые"]): files.append("canon_lore/social/npc_social_rules.yaml")
